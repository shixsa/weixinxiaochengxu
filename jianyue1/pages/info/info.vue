	...
	<view class="container">
		<view class="list">
			...
			<view class="list-item">
				<button type="primary" @tap="logout">作者：李白</button>
				<button type="primary" @tap="logout">关注</button>
				<button type="primary" @tap="logout">收藏</button>
				<button type="primary" @tap="logout">评论</button>
